...
# ---- output dir ----
out_dir <- "figures_svg_media_heatmaps"
...
save_pheatmap_svg(ph_all, svg_path("heatmap_all_significant_media.svg"), width = 9, height = 10)
...
plot_contrast_heatmap_allgroups <- function(cn, show_rownames = TRUE) {
  ...
  save_pheatmap_svg(ph, svg_path(paste0("heatmap_", cn, "_all-groups_media.svg")), width = 9, height = 10)
  invisible(NULL)
}
...
plot_contrast_heatmap_relevant <- function(cn, show_rownames = TRUE) {
  ...
  save_pheatmap_svg(ph, svg_path(paste0("heatmap_", cn, "_relevant-groups_media.svg")), width = 7.5, height = 8.5)
  invisible(NULL)
}
