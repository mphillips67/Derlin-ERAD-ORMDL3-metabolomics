# Media Metabolomics Analysis

Scripts and data used for analysis of conditioned media metabolomics in the manuscript  
*“Derlin-mediated ERAD of lipid regulator ORMDL3 safeguards mitochondrial function”* (DOI: placeholder).

This directory contains all R scripts used to generate the major metabolomic analyses and figures derived from **culture media samples**, including:
...
- `DKO_metab_analysis_pca_volcano_upset_media.R`  
  PCA, differential analysis, volcano plots, and overlap analyses.

- `DKO_metab_analysis_heatmap_media.R`  
  Heatmaps of significant metabolites.

- `DKO_metab_analysis_media_boxplots.R`  
  Targeted metabolite visualization.

- `DKO_metab_enrichment_media_file_generation.R`  
  Generates MetaboAnalyst QEA input files.

- `Enrichment_figures_MSEA_Media.R`  
